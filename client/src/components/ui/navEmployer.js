...
const NavEmployer = () => {
   ...
   const menuItems = [
      ...
      { icon: <Users size={20} />, label: 'Users', path: '/employers/users', adminOnly: false },
      { icon: <MessageCircle size={20} />, label: 'Messages', path: '/messages', badge: 2, adminOnly: false },
      { 
               ...
               <div className="bg-white p-6 rounded-2xl shadow-lg w-11/12 max-w-md mx-auto">
                  ...
                  <div className="flex justify-end space-x-4">
                     <button 
                        ...
                        className="bg-white px-4 py-2 rounded-full border border-black hover:bg-black hover:text-white"
                     >
                        Cancel
                     </button>
                     <button 
                        onClick={confirmLogout} 
                        className="bg-black rounded-full text-white px-4 py-2 hover:bg-red-600"
                     >
