            ...
            <div className="mt-4 sm:mt-0 sm:ml-4 flex-grow">
                ...
                <div className="space-x-4 mt-2 text-gray-600">
                    ...
                    <div className="flex justify-between">    
                      ...
                      <div className="gap-2 -mt-16 justify-end"> {/* grid grid-ro */}
                      <button onClick={handleApply} className="bg-black text-white px-6 py-2 rounded hover:bg-gray-800 ">APPLY NOW</button>
                      {/* <button onClick={handleSaveJob} className="border border-gray-300 px-6 py-2 rounded hover:bg-gray-50">SAVE JOB</button> */}
                      </div>
