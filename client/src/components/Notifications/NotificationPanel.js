...
const NotificationPanel = ({ 
   ...
   if (loading) {
      return (
         <div className="fixed right-4 top-16 w-96 bg-white shadow-lg rounded-lg z-50 p-4">
   ...
   return (
      <div className={`fixed right-4 top-16 bg-white shadow-lg rounded-lg z-50 border border-gray-200 
